...
if __name__ == '__main__':
    ...
    train_csv_path = os.path.join(csv_dir_path, 'trainlist_0.txt')#.format(split_index))
    val_csv_path = os.path.join(csv_dir_path, 'testlist_0.txt')#.format(split_index))
    dst_json_path = os.path.join(csv_dir_path, 'ucf101_x.json')#.format(split_index))
